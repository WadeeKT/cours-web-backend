...
VALUES
    ...
    (3, 'Martin', 'Julie', 'Ju', 'pwdjulie', 'auteur'), --  Derniers enregistrements générés à l'aide d'une IA
...
VALUES
    ...
    (4, 3, 'La programmation en Python', 'Cet article explique les bases de la programmation en Python...', '2024-03-01 09:00:00', '2024-03-02 10:00:00'), -- Derniers enregistrements générés à l'aide d'une IA
...
VALUES
    ...
    (4, 4, 'Le RoiPython', 'Très bon article, merci pour le partage !', '2024-03-02 10:15:00'), -- Derniers enregistrements générés à l'aide d'une IA
